...
namespace NuvoControl.Server.ZoneServer
{
    ...
    public class ZoneController: IZoneController
    {
        ...
        public void SetZoneState(ZoneState zoneState)
        {
            lock (this)
            {
                _log.Trace(m=>m("ZC.SetZoneState: Address={0}, Command={1}", _zoneId.ToString(), zoneState.ToString()));
        ...
        public void NotifySubscribedClients()
        {
            if (_zoneNotification != null)
            {
                _log.Trace(m=>m("ZC.NotifySubscribers: Address={0}, Command={1}",_zoneId.ToString(), _zoneState.ToString()));
        ...
        void _protocolDriver_onZoneStatusUpdate(object sender, ProtocolZoneUpdatedEventArgs e)
        {
            ...
            lock (this)
            {
                ...
                {
                    _log.Trace(m=>m("ZC.onZoneStatusUpdate: Address={0}, Command={1}", _zoneId.ToString(), e.ZoneState.ToString()));
        ...
        private void _protocolDriver_onDeviceStatusUpdate(object sender, ProtocolDeviceUpdatedEventArgs e)
        {
            ...
            lock (this)
            {
                ...
                {
                    _log.Trace(m=>m("ZC.onDeviceStatusUpdate: Address={0}, Command={1}", _zoneId.ToString(), _zoneState.ToString()));
