...
namespace NuvoControl.Client.ServiceAccess.MonitorAndControlService {
    ...
    public partial class ZoneState : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address _sourceField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private int _volumeField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private NuvoControl.Client.ServiceAccess.MonitorAndControlService.ZoneQuality _zoneQualityField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address _source {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public NuvoControl.Client.ServiceAccess.MonitorAndControlService.ZoneQuality _zoneQuality {
            get {
    ...
    public interface IMonitorAndControl {
        ...
        void SetZoneState(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId, NuvoControl.Client.ServiceAccess.MonitorAndControlService.ZoneState stateCommand);
        ...
        NuvoControl.Client.ServiceAccess.MonitorAndControlService.ZoneState GetZoneState(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId);
        ...
        void Monitor(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId);
        ...
        void MonitorMultiple(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address[] zoneIds);
        ...
        void RemoveMonitor(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId);
        ...
        void RemoveMonitorMultiple(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address[] zoneIds);
    }
    ...
    public interface IMonitorAndControlCallback {
        ...
        void OnZoneStateChanged(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId, NuvoControl.Client.ServiceAccess.MonitorAndControlService.ZoneState zoneState);
    }
    ...
    public partial class MonitorAndControlClient : System.ServiceModel.DuplexClientBase<NuvoControl.Client.ServiceAccess.MonitorAndControlService.IMonitorAndControl>, NuvoControl.Client.ServiceAccess.MonitorAndControlService.IMonitorAndControl {
        ...
        public void SetZoneState(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId, NuvoControl.Client.ServiceAccess.MonitorAndControlService.ZoneState stateCommand) {
            base.Channel.SetZoneState(zoneId, stateCommand);
        }
        
        public NuvoControl.Client.ServiceAccess.MonitorAndControlService.ZoneState GetZoneState(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId) {
            return base.Channel.GetZoneState(zoneId);
        }
        
        public void Monitor(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId) {
            base.Channel.Monitor(zoneId);
        }
        
        public void MonitorMultiple(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address[] zoneIds) {
            base.Channel.MonitorMultiple(zoneIds);
        }
        
        public void RemoveMonitor(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address zoneId) {
            base.Channel.RemoveMonitor(zoneId);
        }
        
        public void RemoveMonitorMultiple(NuvoControl.Client.ServiceAccess.MonitorAndControlService.Address[] zoneIds) {
